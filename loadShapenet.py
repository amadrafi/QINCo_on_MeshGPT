...
def load_shapenet(directory, per_category, variations):
    ...
    # Load metadata from JSON (if any)
    ...
    for category in os.listdir(directory):
        ...
        # Debug: how many subfolders / files in category_path
        # Note: We'll not do a simple len(os.listdir(category_path)) because it's recursive
